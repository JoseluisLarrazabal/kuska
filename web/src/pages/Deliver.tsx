...
import { parseOrderRefFromText } from "../lib/ui/orderLink";
...
export default function Deliver() {
  ...
  function goToOrder(text: string) {
    ...
    navigate(`/pedido/${ref}?accion=liberar`);
  }
      ...
      {!manualMode ? (
        ...
        <div className="mt-6 flex flex-col gap-3">
          <Field
            ...
            spellCheck={false}
          />
          <Button onClick={() => goToOrder(manualCode)} disabled={manualCode.trim().length === 0}>
            Continuar
          </Button>
          <button
            type="button"
